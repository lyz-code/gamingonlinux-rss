...
update-mocks:
	@echo "------------------------------"
	@echo "- Updating the mocks content -"
	@echo "------------------------------"

	wget 'https://www.gamingonlinux.com/home/page=1/' -O tests/assets/page_1.html
	wget 'https://www.gamingonlinux.com/2019/04/king-arthurs-gold-the-2d-multiplayer-castle-siege-game-is-now-free-to-play/' -O tests/assets/article.html
